...
class MedApp(MDApp):
    ...
    def info_scr(self):
        ...
        self.layout.add_widget(Label(text=f'[color=#e172f2][b]Disease[/b][/color] : {self.disease[0]}', font_size='50',markup=True))
        self.layout.add_widget(Label(text=f'[color=#e172f2][b]Med[/b][/color] : {self.disease[1]}', font_size='40', markup=True))

        img = Image(source='test.png')
